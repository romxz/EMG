...
*/
double array1[5],array2[5], array3[5];
int counter=0,counter2=0, counter3 = 0;
double rms1=0.0,rms2=0.0,rms3=0.0, sum1=0.0,sum2=0.0,sum3 = 0.0, val1=0.0,val2=0.0,val3=0.0,log_rms1=0.0,log_rms2=0.0,log_rms3 = 0.0,log_rmsa=0.0,log_rmsb=0.0,log_rmsc = 0.0,rms_1=0.0,rms_2=0.0, rms_3 = 0.0;
 ...
 // Serial.print("\t");
  ...
  while(counter2<5)
  {
    ...
    while (counter<v)
    {
        ...
        sum3 = sum3 + sensorVal[3]*sensorVal[3];
