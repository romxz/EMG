...
while current_motion_num < motion_num:
    ...
    print(colors[current_motion_num])
    ...
    while time2 - time1 < motion_time:
        ...
        if current_motion_num == 0:
            a = [5,5,random.random()*5,random.random()*5]
        elif current_motion_num ==1:
            a = [5,5,random.random()*5+5,random.random()*5]
        elif current_motion_num == 2:
            a = [5,5,random.random()*5,random.random()*5+5]
        elif current_motion_num == 3:
            a = [5,5,random.random()*5+5,random.random()*5+5]
